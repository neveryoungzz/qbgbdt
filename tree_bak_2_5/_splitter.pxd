...
cdef class Splitter:
    ...
    # Methods
    cdef int init(self, object X, object invsig, 
                  np.ndarray y, SIZE_t* samples,
    ...
    cdef int node_reset(self, SIZE_t* samples, SIZE_t n_node_samples,
                        double* weighted_n_node_samples, double* prob_weight) nogil except -1
